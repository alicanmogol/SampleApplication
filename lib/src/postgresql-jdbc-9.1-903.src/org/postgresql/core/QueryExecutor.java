...
public interface QueryExecutor {
     ...
     *
     * @throws java.sql.SQLException if query execution fails
     */
     ...
     * @throws java.sql.SQLException if an error occurs while executing the fastpath call
     */
     ...
     * @throws java.sql.SQLException when initializing the given query fails
     */
