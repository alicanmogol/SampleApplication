...
public abstract class ConnectionFactory {
     ...
     * @throws java.sql.SQLException if the connection could not be established.
     */
     ...
     * Implemented by subclasses of {@link org.postgresql.core.ConnectionFactory}.
     *
     * @param host the host to connect to
     * @param port the port to connect to
     * @param user the username to authenticate with; may not be null.
     ...
     * @throws java.sql.SQLException if the connection could not be established for a reason other
