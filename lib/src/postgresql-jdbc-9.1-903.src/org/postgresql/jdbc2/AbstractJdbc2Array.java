...
public abstract class AbstractJdbc2Array
{
    ...
    /**
     * Value of field as {@link org.postgresql.jdbc2.AbstractJdbc2Array.PgArrayList}. Will be initialized only once
    ...
    /**
     * Build {@link java.util.ArrayList} from field's string input. As a result
    ...
    /**
     * Convert {@link java.util.ArrayList} to array.
     *
