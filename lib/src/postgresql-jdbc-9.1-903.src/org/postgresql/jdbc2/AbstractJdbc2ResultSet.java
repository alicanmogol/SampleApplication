...
public abstract class AbstractJdbc2ResultSet implements BaseResultSet, org.postgresql.PGRefCursorResultSet
{
    ...
    throws SQLException
    {
        ...
        if ( deleteStatement == null )
        {
            ...
            deleteStatement = ((Connection) connection).prepareStatement(deleteSQL.toString());
        }
    ...
    throws SQLException
    {
        ...
        else
        {
            ...
            insertStatement = ((Connection) connection).prepareStatement(insertSQL.toString());
    ...
    public void refreshRow() throws SQLException
    {
        ...
        selectStatement = ((Connection) connection).prepareStatement(selectSQL.toString());
    ...
    throws SQLException
    {
        ...
        updateStatement = ((Connection) connection).prepareStatement(updateSQL.toString());
    ...
    boolean isUpdateable() throws SQLException
    {
        ...
        else
        {
            ...
            ResultSet rs = ((Connection) connection).getMetaData().getPrimaryKeys("", quotelessSchemaName, quotelessTableName);
            for (; rs.next(); i++ )
            {
     ...
     * @throws java.sql.SQLException If an error occurs while fetching column.
     ...
     * @throws java.sql.SQLException If state or column is invalid.
     */
