...
public abstract class AbstractJdbc2DatabaseMetaData
{
    ...
    protected ResultSet getProcedures(int jdbcVersion, String catalog, String schemaPattern, String procedureNamePattern) throws SQLException
    {
        ...
        if (connection.haveMinimumServerVersion("7.3"))
        {
            sql = "SELECT NULL AS PROCEDURE_CAT, n.nspname AS PROCEDURE_SCHEM, p.proname AS PROCEDURE_NAME, NULL, NULL, NULL, d.description AS REMARKS, " + DatabaseMetaData.procedureReturnsResult + " AS PROCEDURE_TYPE ";
            if (jdbcVersion >= 4) {
        ...
        {
            sql = "SELECT NULL AS PROCEDURE_CAT, NULL AS PROCEDURE_SCHEM, p.proname AS PROCEDURE_NAME, NULL, NULL, NULL, d.description AS REMARKS, " + DatabaseMetaData.procedureReturnsResult + " AS PROCEDURE_TYPE ";
            if (jdbcVersion >= 4) {
                sql += ", p.proname || '_' || p.oid AS SPECIFIC_NAME ";
            }
            sql += " FROM pg_proc p " +
        ...
        {
            sql = "SELECT NULL AS PROCEDURE_CAT, NULL AS PROCEDURE_SCHEM, p.proname AS PROCEDURE_NAME, NULL, NULL, NULL, NULL AS REMARKS, " + DatabaseMetaData.procedureReturnsResult + " AS PROCEDURE_TYPE ";
            if (jdbcVersion >= 4) {
                sql += ", p.proname || '_' || p.oid AS SPECIFIC_NAME ";
            }
            sql += " FROM pg_proc p ";
    ...
    protected ResultSet getProcedureColumns(int jdbcVersion, String catalog, String schemaPattern, String procedureNamePattern, String columnNamePattern) throws SQLException
    {
        ...
        while (rs.next())
        {
            ...
            if (returnTypeType.equals("b") || returnTypeType.equals("d") || (returnTypeType.equals("p") && argModesArray == null))
            {
                ...
                tuple[4] = connection.encodeString(Integer.toString(DatabaseMetaData.procedureColumnReturn));
            ...
            if (returnTypeType.equals("c") || (returnTypeType.equals("p") && argModesArray != null))
            {
                ...
                while (columnrs.next())
                {
                    ...
                    tuple[4] = connection.encodeString(Integer.toString(DatabaseMetaData.procedureColumnResult));
    ...
    protected ResultSet getColumns(int jdbcVersion, String catalog, String schemaPattern, String tableNamePattern, String columnNamePattern) throws SQLException
    {
        ...
        while (rs.next())
        {
            ...
            tuple[10] = connection.encodeString(Integer.toString(rs.getBoolean("attnotnull") ? DatabaseMetaData.columnNoNulls : DatabaseMetaData.columnNullable)); // Nullable
    ...
    protected ResultSet getImportedExportedKeys(String primaryCatalog, String primarySchema, String primaryTable, String foreignCatalog, String foreignSchema, String foreignTable) throws SQLException
    {
        ...
        while ( rs.next() )
        {
            ...
            if (updateRule != null )
            {
                ...
                int action = DatabaseMetaData.importedKeyNoAction;

                if ( rule == null || "noaction".equals(rule) )
                    action = DatabaseMetaData.importedKeyNoAction;
                if ("cascade".equals(rule))
                    action = DatabaseMetaData.importedKeyCascade;
                else if ("setnull".equals(rule))
                    action = DatabaseMetaData.importedKeySetNull;
                else if ("setdefault".equals(rule))
                    action = DatabaseMetaData.importedKeySetDefault;
                else if ("restrict".equals(rule))
                    action = DatabaseMetaData.importedKeyRestrict;
            ...
            // DEFERRABILITY
            int deferrability = DatabaseMetaData.importedKeyNotDeferrable;
            ...
            if (deferrable)
            {
                if (initiallyDeferred)
                    ...
                    deferrability = DatabaseMetaData.importedKeyInitiallyImmediate;
            }
    ...
    */
                                     ...
                                     ) throws SQLException
    {
        String sql = "select "
                     ...
                     + "CASE WHEN t.typtype='c' then " + Types.STRUCT + " else " + Types.DISTINCT + " end as data_type, pg_catalog.obj_description(t.oid, 'pg_type')  "
    ...
    {
        return ((AbstractJdbc2Connection)connection).createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
    }
