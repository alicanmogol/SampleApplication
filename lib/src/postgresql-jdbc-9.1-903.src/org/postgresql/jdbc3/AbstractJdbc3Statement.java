...
public abstract class AbstractJdbc3Statement extends org.postgresql.jdbc2.AbstractJdbc2Statement
{
     ...
     * @exception java.sql.SQLException if a database access error occurs, the given
     ...
     *     that return nothing
     * @exception java.sql.SQLException if a database access error occurs or the SQL
     ...
     * @param parameterName the name of the parameter
     * @param x the object containing the input parameter value
     * @exception java.sql.SQLException if a database access error occurs or if the given
