...
public class CopyManager {
     ...
     * @throws java.sql.SQLException on database usage errors
     * @throws java.io.IOException upon writer or database connection failure
     */
     ...
     * @return number of rows updated for server 8.2 or newer; -1 for older
     * @throws java.sql.SQLException on database usage errors
     * @throws java.io.IOException upon output stream or database connection failure
     */
     ...
     * @return number of rows updated for server 8.2 or newer; -1 for older
     * @throws java.sql.SQLException on database usage issues
     * @throws java.io.IOException upon reader or database connection failure
     */
     ...
     * @return number of rows updated for server 8.2 or newer; -1 for older
     * @throws java.sql.SQLException on database usage issues
     * @throws java.io.IOException upon input stream or database connection failure
     */
