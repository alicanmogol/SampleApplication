...
public class Fastpath
{
     ...
     * @param args FastpathArguments to pass to fastpath
     * @return null if no data, Integer if an integer result, or byte[] otherwise
     * @exception java.sql.SQLException if name is unknown or if a database-access error
     * occurs.
     ...
     * @exception java.sql.SQLException if a database-access error occurs or no result
     */
     ...
     * @exception java.sql.SQLException is function is unknown.
     */
