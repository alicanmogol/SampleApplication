...
public class DateTest extends TestCase
{
    ...
    public void testSetDate() throws SQLException
    {
        ...
        ps.setObject(1, Timestamp.valueOf("1950-04-02 12:00:00"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Timestamp.valueOf("1970-11-30 3:00:00"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Timestamp.valueOf("1988-01-01 13:00:00"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Timestamp.valueOf("2003-07-09 12:00:00"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, "1934-02-28", Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, "1969-04-03", Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, "1982-08-03", Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, "2012-03-15", Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Date.valueOf("1912-05-01"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Date.valueOf("1971-12-15"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Date.valueOf("1984-12-03"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Date.valueOf("2000-01-01"), Types.DATE);
        assertEquals(1, ps.executeUpdate());

        ps.setObject(1, Date.valueOf("3456-01-01"), Types.DATE);
        assertEquals(1, ps.executeUpdate());
