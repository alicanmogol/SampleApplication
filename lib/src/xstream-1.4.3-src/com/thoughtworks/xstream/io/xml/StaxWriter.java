...
public class StaxWriter extends AbstractXmlWriter {
     ...
     * @throws javax.xml.stream.XMLStreamException if the events could not be written to the output
     * @since 1.4
     */
     ...
     *             {@link com.thoughtworks.xstream.io.xml.StaxWriter#StaxWriter(QNameMap, javax.xml.stream.XMLStreamWriter, boolean, boolean, NameCoder)}
     *             instead
     */
    public StaxWriter(
        QNameMap qnameMap, XMLStreamWriter out, boolean writeEnclosingDocument,
