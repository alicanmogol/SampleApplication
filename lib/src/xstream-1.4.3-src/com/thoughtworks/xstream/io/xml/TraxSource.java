...
/**
 * A {@link javax.xml.transform.sax.SAXSource JAXP TrAX Source} that enables using XStream object serialization as
...
public class TraxSource extends SAXSource {
     ...
     * {@link javax.xml.transform.sax.SAXSource#FEATURE} value defined by its superclass to be considered as a SAXSource
     ...
     * if the provided reader object does not implement the SAX {@link org.xml.sax.XMLFilter} interface.
