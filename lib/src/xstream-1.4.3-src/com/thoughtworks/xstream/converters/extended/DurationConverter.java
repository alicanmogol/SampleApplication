 ...
 * {@link javax.xml.datatype.Duration}. The implementation uses a {@link javax.xml.datatype.DatatypeFactory} to create Duration
 * objects. If no factory is provided and the instantiation of the internal factory fails with a
 * {@link javax.xml.datatype.DatatypeConfigurationException}, the converter will not claim the responsibility for
 * Duration objects.
 * 
