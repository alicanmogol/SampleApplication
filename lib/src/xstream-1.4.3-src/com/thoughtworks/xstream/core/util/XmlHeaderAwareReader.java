...
/**
 * A {@link java.io.Reader} that evaluates the XML header. It selects its encoding based on the encoding read with the XML
 * header of the provided {@link java.io.InputStream}. The default encoding is <em>UTF-8</em> and the version is 1.0 if the
...
public final class XmlHeaderAwareReader extends Reader {
     ...
     * 
     * @param in the {@link java.io.InputStream}
     * @throws java.io.UnsupportedEncodingException if the encoding is not supported
     * @throws java.io.IOException occurred while reading the XML header
     * @since 1.3
     */
