...
public class XStreamer {
     ...
     * 
     * @throws java.io.ObjectStreamException if the XML contains non-serializable elements
     * @throws com.thoughtworks.xstream.XStreamException if the object cannot be serialized
     * @since 1.2
     * @see #toXML(XStream, Object, java.io.Writer)
     */
     ...
     * should use {@link com.thoughtworks.xstream.XStreamer#fromXML(java.io.Reader)} or one of the other overloaded
     ...
     * </p>
     * 
     * @throws java.io.IOException if an error occurs reading from the Writer.
     * @throws com.thoughtworks.xstream.XStreamException if the object cannot be serialized
     * @since 1.2
     */
     ...
     * @throws java.io.ObjectStreamException if the XML contains non-deserializable elements
     ...
     * internally an XppDriver to load the contained XStream instance.
     * 
     * @throws java.io.IOException if an error occurs reading from the Reader.
     * @throws ClassNotFoundException if a class in the XML stream cannot be found
     * @throws com.thoughtworks.xstream.XStreamException if the object cannot be deserialized
     * @since 1.2
     * @see #toXML(XStream, Object, java.io.Writer)
